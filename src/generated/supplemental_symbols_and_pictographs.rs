...
impl std::convert::TryFrom<u32> for SupplementalSymbolsandPictographs {
    type Error = ();
...
impl SupplementalSymbolsandPictographs {
    ...
    pub fn name(&self) -> &str {
        match self {
            SupplementalSymbolsandPictographs::CircledCrossFormeeWithFourDots => "circled cross formee with four dots",
            SupplementalSymbolsandPictographs::CircledCrossFormeeWithTwoDots => "circled cross formee with two dots",
            SupplementalSymbolsandPictographs::CircledCrossFormee => "circled cross formee",
            SupplementalSymbolsandPictographs::LeftHalfCircleWithFourDots => "left half circle with four dots",
            SupplementalSymbolsandPictographs::LeftHalfCircleWithThreeDots => "left half circle with three dots",
            SupplementalSymbolsandPictographs::LeftHalfCircleWithTwoDots => "left half circle with two dots",
            SupplementalSymbolsandPictographs::LeftHalfCircleWithDot => "left half circle with dot",
            SupplementalSymbolsandPictographs::LeftHalfCircle => "left half circle",
            SupplementalSymbolsandPictographs::DownwardFacingHook => "downward facing hook",
            SupplementalSymbolsandPictographs::DownwardFacingNotchedHook => "downward facing notched hook",
            SupplementalSymbolsandPictographs::DownwardFacingHookWithDot => "downward facing hook with dot",
            SupplementalSymbolsandPictographs::DownwardFacingNotchedHookWithDot => "downward facing notched hook with dot",
            SupplementalSymbolsandPictographs::WhiteHeart => "white heart",
            SupplementalSymbolsandPictographs::BrownHeart => "brown heart",
            SupplementalSymbolsandPictographs::PinchingHand => "pinching hand",
            SupplementalSymbolsandPictographs::ZipperDashMouthFace => "zipper-mouth face",
            SupplementalSymbolsandPictographs::MoneyDashMouthFace => "money-mouth face",
            SupplementalSymbolsandPictographs::FaceWithThermometer => "face with thermometer",
            SupplementalSymbolsandPictographs::NerdFace => "nerd face",
            SupplementalSymbolsandPictographs::ThinkingFace => "thinking face",
            SupplementalSymbolsandPictographs::FaceWithHeadDashBandage => "face with head-bandage",
            SupplementalSymbolsandPictographs::RobotFace => "robot face",
            SupplementalSymbolsandPictographs::HuggingFace => "hugging face",
            SupplementalSymbolsandPictographs::SignOfTheHorns => "sign of the horns",
            SupplementalSymbolsandPictographs::CallMeHand => "call me hand",
            SupplementalSymbolsandPictographs::RaisedBackOfHand => "raised back of hand",
            SupplementalSymbolsandPictographs::LeftDashFacingFist => "left-facing fist",
            SupplementalSymbolsandPictographs::RightDashFacingFist => "right-facing fist",
            SupplementalSymbolsandPictographs::Handshake => "handshake",
            SupplementalSymbolsandPictographs::HandWithIndexAndMiddleFingersCrossed => "hand with index and middle fingers crossed",
            SupplementalSymbolsandPictographs::ILoveYouHandSign => "i love you hand sign",
            SupplementalSymbolsandPictographs::FaceWithCowboyHat => "face with cowboy hat",
            SupplementalSymbolsandPictographs::ClownFace => "clown face",
            SupplementalSymbolsandPictographs::NauseatedFace => "nauseated face",
            SupplementalSymbolsandPictographs::RollingOnTheFloorLaughing => "rolling on the floor laughing",
            SupplementalSymbolsandPictographs::DroolingFace => "drooling face",
            SupplementalSymbolsandPictographs::LyingFace => "lying face",
            SupplementalSymbolsandPictographs::FacePalm => "face palm",
            SupplementalSymbolsandPictographs::SneezingFace => "sneezing face",
            SupplementalSymbolsandPictographs::FaceWithOneEyebrowRaised => "face with one eyebrow raised",
            SupplementalSymbolsandPictographs::GrinningFaceWithStarEyes => "grinning face with star eyes",
            SupplementalSymbolsandPictographs::GrinningFaceWithOneLargeAndOneSmallEye => "grinning face with one large and one small eye",
            SupplementalSymbolsandPictographs::FaceWithFingerCoveringClosedLips => "face with finger covering closed lips",
            SupplementalSymbolsandPictographs::SeriousFaceWithSymbolsCoveringMouth => "serious face with symbols covering mouth",
            SupplementalSymbolsandPictographs::SmilingFaceWithSmilingEyesAndHandCoveringMouth => "smiling face with smiling eyes and hand covering mouth",
            SupplementalSymbolsandPictographs::FaceWithOpenMouthVomiting => "face with open mouth vomiting",
            SupplementalSymbolsandPictographs::ShockedFaceWithExplodingHead => "shocked face with exploding head",
            SupplementalSymbolsandPictographs::PregnantWoman => "pregnant woman",
            SupplementalSymbolsandPictographs::BreastDashFeeding => "breast-feeding",
            SupplementalSymbolsandPictographs::PalmsUpTogether => "palms up together",
            SupplementalSymbolsandPictographs::Selfie => "selfie",
            SupplementalSymbolsandPictographs::Prince => "prince",
            SupplementalSymbolsandPictographs::ManInTuxedo => "man in tuxedo",
            SupplementalSymbolsandPictographs::MotherChristmas => "mother christmas",
            SupplementalSymbolsandPictographs::Shrug => "shrug",
            SupplementalSymbolsandPictographs::PersonDoingCartwheel => "person doing cartwheel",
            SupplementalSymbolsandPictographs::Juggling => "juggling",
            SupplementalSymbolsandPictographs::Fencer => "fencer",
            SupplementalSymbolsandPictographs::ModernPentathlon => "modern pentathlon",
            SupplementalSymbolsandPictographs::Wrestlers => "wrestlers",
            SupplementalSymbolsandPictographs::WaterPolo => "water polo",
            SupplementalSymbolsandPictographs::Handball => "handball",
            SupplementalSymbolsandPictographs::DivingMask => "diving mask",
            SupplementalSymbolsandPictographs::WiltedFlower => "wilted flower",
            SupplementalSymbolsandPictographs::DrumWithDrumsticks => "drum with drumsticks",
            SupplementalSymbolsandPictographs::ClinkingGlasses => "clinking glasses",
            SupplementalSymbolsandPictographs::TumblerGlass => "tumbler glass",
            SupplementalSymbolsandPictographs::Spoon => "spoon",
            SupplementalSymbolsandPictographs::GoalNet => "goal net",
            SupplementalSymbolsandPictographs::Rifle => "rifle",
            SupplementalSymbolsandPictographs::FirstPlaceMedal => "first place medal",
            SupplementalSymbolsandPictographs::SecondPlaceMedal => "second place medal",
            SupplementalSymbolsandPictographs::ThirdPlaceMedal => "third place medal",
            SupplementalSymbolsandPictographs::BoxingGlove => "boxing glove",
            SupplementalSymbolsandPictographs::MartialArtsUniform => "martial arts uniform",
            SupplementalSymbolsandPictographs::CurlingStone => "curling stone",
            SupplementalSymbolsandPictographs::LacrosseStickAndBall => "lacrosse stick and ball",
            SupplementalSymbolsandPictographs::Softball => "softball",
            SupplementalSymbolsandPictographs::FlyingDisc => "flying disc",
            SupplementalSymbolsandPictographs::Croissant => "croissant",
            SupplementalSymbolsandPictographs::Avocado => "avocado",
            SupplementalSymbolsandPictographs::Cucumber => "cucumber",
            SupplementalSymbolsandPictographs::Bacon => "bacon",
            SupplementalSymbolsandPictographs::Potato => "potato",
            SupplementalSymbolsandPictographs::Carrot => "carrot",
            SupplementalSymbolsandPictographs::BaguetteBread => "baguette bread",
            SupplementalSymbolsandPictographs::GreenSalad => "green salad",
            SupplementalSymbolsandPictographs::ShallowPanOfFood => "shallow pan of food",
            SupplementalSymbolsandPictographs::StuffedFlatbread => "stuffed flatbread",
            SupplementalSymbolsandPictographs::Egg => "egg",
            SupplementalSymbolsandPictographs::GlassOfMilk => "glass of milk",
            SupplementalSymbolsandPictographs::Peanuts => "peanuts",
            SupplementalSymbolsandPictographs::Kiwifruit => "kiwifruit",
            SupplementalSymbolsandPictographs::Pancakes => "pancakes",
            SupplementalSymbolsandPictographs::Dumpling => "dumpling",
            SupplementalSymbolsandPictographs::FortuneCookie => "fortune cookie",
            SupplementalSymbolsandPictographs::TakeoutBox => "takeout box",
            SupplementalSymbolsandPictographs::Chopsticks => "chopsticks",
            SupplementalSymbolsandPictographs::BowlWithSpoon => "bowl with spoon",
            SupplementalSymbolsandPictographs::CupWithStraw => "cup with straw",
            SupplementalSymbolsandPictographs::Coconut => "coconut",
            SupplementalSymbolsandPictographs::Broccoli => "broccoli",
            SupplementalSymbolsandPictographs::Pie => "pie",
            SupplementalSymbolsandPictographs::Pretzel => "pretzel",
            SupplementalSymbolsandPictographs::CutOfMeat => "cut of meat",
            SupplementalSymbolsandPictographs::Sandwich => "sandwich",
            SupplementalSymbolsandPictographs::CannedFood => "canned food",
            SupplementalSymbolsandPictographs::LeafyGreen => "leafy green",
            SupplementalSymbolsandPictographs::Mango => "mango",
            SupplementalSymbolsandPictographs::MoonCake => "moon cake",
            SupplementalSymbolsandPictographs::Bagel => "bagel",
            SupplementalSymbolsandPictographs::SmilingFaceWithSmilingEyesAndThreeHearts => "smiling face with smiling eyes and three hearts",
            SupplementalSymbolsandPictographs::YawningFace => "yawning face",
            SupplementalSymbolsandPictographs::FaceWithPartyHornAndPartyHat => "face with party horn and party hat",
            SupplementalSymbolsandPictographs::FaceWithUnevenEyesAndWavyMouth => "face with uneven eyes and wavy mouth",
            SupplementalSymbolsandPictographs::OverheatedFace => "overheated face",
            SupplementalSymbolsandPictographs::FreezingFace => "freezing face",
            SupplementalSymbolsandPictographs::FaceWithPleadingEyes => "face with pleading eyes",
            SupplementalSymbolsandPictographs::Sari => "sari",
            SupplementalSymbolsandPictographs::LabCoat => "lab coat",
            SupplementalSymbolsandPictographs::Goggles => "goggles",
            SupplementalSymbolsandPictographs::HikingBoot => "hiking boot",
            SupplementalSymbolsandPictographs::FlatShoe => "flat shoe",
            SupplementalSymbolsandPictographs::Crab => "crab",
            SupplementalSymbolsandPictographs::LionFace => "lion face",
            SupplementalSymbolsandPictographs::Scorpion => "scorpion",
            SupplementalSymbolsandPictographs::Turkey => "turkey",
            SupplementalSymbolsandPictographs::UnicornFace => "unicorn face",
            SupplementalSymbolsandPictographs::Eagle => "eagle",
            SupplementalSymbolsandPictographs::Duck => "duck",
            SupplementalSymbolsandPictographs::Bat => "bat",
            SupplementalSymbolsandPictographs::Shark => "shark",
            SupplementalSymbolsandPictographs::Owl => "owl",
            SupplementalSymbolsandPictographs::FoxFace => "fox face",
            SupplementalSymbolsandPictographs::Butterfly => "butterfly",
            SupplementalSymbolsandPictographs::Deer => "deer",
            SupplementalSymbolsandPictographs::Gorilla => "gorilla",
            SupplementalSymbolsandPictographs::Lizard => "lizard",
            ...
            SupplementalSymbolsandPictographs::Shrimp => "shrimp",
            SupplementalSymbolsandPictographs::Squid => "squid",
            SupplementalSymbolsandPictographs::GiraffeFace => "giraffe face",
            SupplementalSymbolsandPictographs::ZebraFace => "zebra face",
            SupplementalSymbolsandPictographs::Hedgehog => "hedgehog",
            SupplementalSymbolsandPictographs::Sauropod => "sauropod",
            SupplementalSymbolsandPictographs::TDashRex => "t-rex",
            SupplementalSymbolsandPictographs::Cricket => "cricket",
            SupplementalSymbolsandPictographs::Kangaroo => "kangaroo",
            SupplementalSymbolsandPictographs::Llama => "llama",
            SupplementalSymbolsandPictographs::Peacock => "peacock",
            ...
            SupplementalSymbolsandPictographs::Flamingo => "flamingo",
            SupplementalSymbolsandPictographs::Oyster => "oyster",
            SupplementalSymbolsandPictographs::GuideDog => "guide dog",
            SupplementalSymbolsandPictographs::ProbingCane => "probing cane",
            SupplementalSymbolsandPictographs::EmojiComponentRedHair => "emoji component red hair",
            SupplementalSymbolsandPictographs::EmojiComponentCurlyHair => "emoji component curly hair",
            SupplementalSymbolsandPictographs::EmojiComponentBald => "emoji component bald",
            SupplementalSymbolsandPictographs::EmojiComponentWhiteHair => "emoji component white hair",
            SupplementalSymbolsandPictographs::Bone => "bone",
            SupplementalSymbolsandPictographs::Leg => "leg",
            SupplementalSymbolsandPictographs::Foot => "foot",
            SupplementalSymbolsandPictographs::Tooth => "tooth",
            SupplementalSymbolsandPictographs::Superhero => "superhero",
            SupplementalSymbolsandPictographs::Supervillain => "supervillain",
            SupplementalSymbolsandPictographs::SafetyVest => "safety vest",
            SupplementalSymbolsandPictographs::EarWithHearingAid => "ear with hearing aid",
            SupplementalSymbolsandPictographs::MotorizedWheelchair => "motorized wheelchair",
            SupplementalSymbolsandPictographs::ManualWheelchair => "manual wheelchair",
            SupplementalSymbolsandPictographs::MechanicalArm => "mechanical arm",
            SupplementalSymbolsandPictographs::MechanicalLeg => "mechanical leg",
            SupplementalSymbolsandPictographs::CheeseWedge => "cheese wedge",
            SupplementalSymbolsandPictographs::Cupcake => "cupcake",
            SupplementalSymbolsandPictographs::SaltShaker => "salt shaker",
            SupplementalSymbolsandPictographs::BeverageBox => "beverage box",
            SupplementalSymbolsandPictographs::Garlic => "garlic",
            SupplementalSymbolsandPictographs::Onion => "onion",
            SupplementalSymbolsandPictographs::Falafel => "falafel",
            SupplementalSymbolsandPictographs::Waffle => "waffle",
            SupplementalSymbolsandPictographs::Butter => "butter",
            SupplementalSymbolsandPictographs::MateDrink => "mate drink",
            SupplementalSymbolsandPictographs::IceCube => "ice cube",
            SupplementalSymbolsandPictographs::StandingPerson => "standing person",
            SupplementalSymbolsandPictographs::KneelingPerson => "kneeling person",
            SupplementalSymbolsandPictographs::DeafPerson => "deaf person",
            SupplementalSymbolsandPictographs::FaceWithMonocle => "face with monocle",
            SupplementalSymbolsandPictographs::Adult => "adult",
            SupplementalSymbolsandPictographs::Child => "child",
            SupplementalSymbolsandPictographs::OlderAdult => "older adult",
            SupplementalSymbolsandPictographs::BeardedPerson => "bearded person",
            SupplementalSymbolsandPictographs::PersonWithHeadscarf => "person with headscarf",
            SupplementalSymbolsandPictographs::PersonInSteamyRoom => "person in steamy room",
            SupplementalSymbolsandPictographs::PersonClimbing => "person climbing",
            SupplementalSymbolsandPictographs::PersonInLotusPosition => "person in lotus position",
            SupplementalSymbolsandPictographs::Mage => "mage",
            SupplementalSymbolsandPictographs::Fairy => "fairy",
            SupplementalSymbolsandPictographs::Vampire => "vampire",
            SupplementalSymbolsandPictographs::Merperson => "merperson",
            ...
            SupplementalSymbolsandPictographs::Zombie => "zombie",
            SupplementalSymbolsandPictographs::Brain => "brain",
            SupplementalSymbolsandPictographs::OrangeHeart => "orange heart",
            SupplementalSymbolsandPictographs::BilledCap => "billed cap",
            SupplementalSymbolsandPictographs::Scarf => "scarf",
            SupplementalSymbolsandPictographs::Gloves => "gloves",
            SupplementalSymbolsandPictographs::Coat => "coat",
            SupplementalSymbolsandPictographs::Socks => "socks",
            SupplementalSymbolsandPictographs::RedGiftEnvelope => "red gift envelope",
            SupplementalSymbolsandPictographs::Firecracker => "firecracker",
            SupplementalSymbolsandPictographs::JigsawPuzzlePiece => "jigsaw puzzle piece",
            SupplementalSymbolsandPictographs::TestTube => "test tube",
            SupplementalSymbolsandPictographs::PetriDish => "petri dish",
            SupplementalSymbolsandPictographs::DnaDoubleHelix => "dna double helix",
            SupplementalSymbolsandPictographs::Compass => "compass",
            SupplementalSymbolsandPictographs::Abacus => "abacus",
            SupplementalSymbolsandPictographs::FireExtinguisher => "fire extinguisher",
            SupplementalSymbolsandPictographs::Toolbox => "toolbox",
            SupplementalSymbolsandPictographs::Brick => "brick",
            SupplementalSymbolsandPictographs::Magnet => "magnet",
            SupplementalSymbolsandPictographs::Luggage => "luggage",
            SupplementalSymbolsandPictographs::LotionBottle => "lotion bottle",
            SupplementalSymbolsandPictographs::SpoolOfThread => "spool of thread",
            SupplementalSymbolsandPictographs::BallOfYarn => "ball of yarn",
            SupplementalSymbolsandPictographs::SafetyPin => "safety pin",
            SupplementalSymbolsandPictographs::TeddyBear => "teddy bear",
            SupplementalSymbolsandPictographs::Broom => "broom",
            SupplementalSymbolsandPictographs::Basket => "basket",
            SupplementalSymbolsandPictographs::RollOfPaper => "roll of paper",
            SupplementalSymbolsandPictographs::BarOfSoap => "bar of soap",
            SupplementalSymbolsandPictographs::Sponge => "sponge",
            SupplementalSymbolsandPictographs::Receipt => "receipt",
        }
    }
