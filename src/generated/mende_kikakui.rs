...
/// 𞠐 𞠑 𞠒 𞠓 𞠔 𞠕 𞠖 𞠗 𞠘 𞠙 𞠚 𞠛 𞠜 𞠝 𞠞 𞠟\
/// 𞠠 𞠡 𞠢 𞠣 𞠤 𞠥 𞠦 𞠧 𞠨 𞠩 𞠪 𞠫 𞠬 𞠭 𞠮 𞠯\
/// 𞠰 𞠱 𞠲 𞠳 𞠴 𞠵 𞠶 𞠷 𞠸 𞠹 𞠺 𞠻 𞠼 𞠽 𞠾 𞠿\
/// 𞡀 𞡁 𞡂 𞡃 𞡄 𞡅 𞡆 𞡇 𞡈 𞡉 𞡊 𞡋 𞡌 𞡍 𞡎 𞡏\
/// 𞡐 𞡑 𞡒 𞡓 𞡔 𞡕 𞡖 𞡗 𞡘 𞡙 𞡚 𞡛 𞡜 𞡝 𞡞 𞡟\
/// 𞡠 𞡡 𞡢 𞡣 𞡤 𞡥 𞡦 𞡧 𞡨 𞡩 𞡪 𞡫 𞡬 𞡭 𞡮 𞡯\
/// 𞡰 𞡱 𞡲 𞡳 𞡴 𞡵 𞡶 𞡷 𞡸 𞡹 𞡺 𞡻 𞡼 𞡽 𞡾 𞡿\
/// 𞢀 𞢁 𞢂 𞢃 𞢄 𞢅 𞢆 𞢇 𞢈 𞢉 𞢊 𞢋 𞢌 𞢍 𞢎 𞢏\
/// 𞢐 𞢑 𞢒 𞢓 𞢔 𞢕 𞢖 𞢗 𞢘 𞢙 𞢚 𞢛 𞢜 𞢝 𞢞 𞢟\
/// 𞢠 𞢡 𞢢 𞢣 𞢤 𞢥 𞢦 𞢧 𞢨 𞢩 𞢪 𞢫 𞢬 𞢭 𞢮 𞢯\
/// 𞢰 𞢱 𞢲 𞢳 𞢴 𞢵 𞢶 𞢷 𞢸 𞢹 𞢺 𞢻 𞢼 𞢽 𞢾 𞢿\
/// 𞣀 𞣁 𞣂 𞣃 𞣄 𞣇 𞣈 𞣉 𞣊 𞣋 𞣌 𞣍 𞣎 𞣏 𞣐 𞣑\
/// 𞣒 𞣓 𞣔 𞣕 𞣖\
...
pub mod constants {
    ...
    /// \u{1e801}: '𞠁'
    pub const SYLLABLE_M002_KA: char = '𞠁';
    /// \u{1e802}: '𞠂'
    pub const SYLLABLE_M003_KU: char = '𞠂';
    /// \u{1e803}: '𞠃'
    pub const SYLLABLE_M065_KEE: char = '𞠃';
    /// \u{1e804}: '𞠄'
    pub const SYLLABLE_M095_KE: char = '𞠄';
    /// \u{1e805}: '𞠅'
    pub const SYLLABLE_M076_KOO: char = '𞠅';
    /// \u{1e806}: '𞠆'
    pub const SYLLABLE_M048_KO: char = '𞠆';
    /// \u{1e807}: '𞠇'
    pub const SYLLABLE_M179_KUA: char = '𞠇';
    /// \u{1e808}: '𞠈'
    pub const SYLLABLE_M004_WI: char = '𞠈';
    /// \u{1e809}: '𞠉'
    pub const SYLLABLE_M005_WA: char = '𞠉';
    /// \u{1e80a}: '𞠊'
    pub const SYLLABLE_M006_WU: char = '𞠊';
    /// \u{1e80b}: '𞠋'
    pub const SYLLABLE_M126_WEE: char = '𞠋';
    /// \u{1e80c}: '𞠌'
    pub const SYLLABLE_M118_WE: char = '𞠌';
    /// \u{1e80d}: '𞠍'
    pub const SYLLABLE_M114_WOO: char = '𞠍';
    /// \u{1e80e}: '𞠎'
    pub const SYLLABLE_M045_WO: char = '𞠎';
    /// \u{1e80f}: '𞠏'
    pub const SYLLABLE_M194_WUI: char = '𞠏';
    /// \u{1e810}: '𞠐'
    pub const SYLLABLE_M143_WEI: char = '𞠐';
    /// \u{1e811}: '𞠑'
    pub const SYLLABLE_M061_WVI: char = '𞠑';
    /// \u{1e812}: '𞠒'
    pub const SYLLABLE_M049_WVA: char = '𞠒';
    /// \u{1e813}: '𞠓'
    pub const SYLLABLE_M139_WVE: char = '𞠓';
    /// \u{1e814}: '𞠔'
    pub const SYLLABLE_M007_MIN: char = '𞠔';
    /// \u{1e815}: '𞠕'
    pub const SYLLABLE_M008_MAN: char = '𞠕';
    /// \u{1e816}: '𞠖'
    pub const SYLLABLE_M009_MUN: char = '𞠖';
    /// \u{1e817}: '𞠗'
    pub const SYLLABLE_M059_MEN: char = '𞠗';
    /// \u{1e818}: '𞠘'
    pub const SYLLABLE_M094_MON: char = '𞠘';
    /// \u{1e819}: '𞠙'
    pub const SYLLABLE_M154_MUAN: char = '𞠙';
    /// \u{1e81a}: '𞠚'
    pub const SYLLABLE_M189_MUEN: char = '𞠚';
    /// \u{1e81b}: '𞠛'
    pub const SYLLABLE_M010_BI: char = '𞠛';
    /// \u{1e81c}: '𞠜'
    pub const SYLLABLE_M011_BA: char = '𞠜';
    /// \u{1e81d}: '𞠝'
    pub const SYLLABLE_M012_BU: char = '𞠝';
    /// \u{1e81e}: '𞠞'
    pub const SYLLABLE_M150_BEE: char = '𞠞';
    /// \u{1e81f}: '𞠟'
    pub const SYLLABLE_M097_BE: char = '𞠟';
    /// \u{1e820}: '𞠠'
    pub const SYLLABLE_M103_BOO: char = '𞠠';
    /// \u{1e821}: '𞠡'
    pub const SYLLABLE_M138_BO: char = '𞠡';
    /// \u{1e822}: '𞠢'
    pub const SYLLABLE_M013_I: char = '𞠢';
    /// \u{1e823}: '𞠣'
    pub const SYLLABLE_M014_A: char = '𞠣';
    /// \u{1e824}: '𞠤'
    pub const SYLLABLE_M015_U: char = '𞠤';
    /// \u{1e825}: '𞠥'
    pub const SYLLABLE_M163_EE: char = '𞠥';
    /// \u{1e826}: '𞠦'
    pub const SYLLABLE_M100_E: char = '𞠦';
    /// \u{1e827}: '𞠧'
    pub const SYLLABLE_M165_OO: char = '𞠧';
    /// \u{1e828}: '𞠨'
    pub const SYLLABLE_M147_O: char = '𞠨';
    /// \u{1e829}: '𞠩'
    pub const SYLLABLE_M137_EI: char = '𞠩';
    /// \u{1e82a}: '𞠪'
    pub const SYLLABLE_M131_IN: char = '𞠪';
    /// \u{1e82b}: '𞠫'
    pub const SYLLABLE_M135_IN: char = '𞠫';
    /// \u{1e82c}: '𞠬'
    pub const SYLLABLE_M195_AN: char = '𞠬';
    /// \u{1e82d}: '𞠭'
    pub const SYLLABLE_M178_EN: char = '𞠭';
    /// \u{1e82e}: '𞠮'
    pub const SYLLABLE_M019_SI: char = '𞠮';
    /// \u{1e82f}: '𞠯'
    pub const SYLLABLE_M020_SA: char = '𞠯';
    /// \u{1e830}: '𞠰'
    pub const SYLLABLE_M021_SU: char = '𞠰';
    /// \u{1e831}: '𞠱'
    pub const SYLLABLE_M162_SEE: char = '𞠱';
    /// \u{1e832}: '𞠲'
    pub const SYLLABLE_M116_SE: char = '𞠲';
    /// \u{1e833}: '𞠳'
    pub const SYLLABLE_M136_SOO: char = '𞠳';
    /// \u{1e834}: '𞠴'
    pub const SYLLABLE_M079_SO: char = '𞠴';
    /// \u{1e835}: '𞠵'
    pub const SYLLABLE_M196_SIA: char = '𞠵';
    /// \u{1e836}: '𞠶'
    pub const SYLLABLE_M025_LI: char = '𞠶';
    /// \u{1e837}: '𞠷'
    pub const SYLLABLE_M026_LA: char = '𞠷';
    /// \u{1e838}: '𞠸'
    pub const SYLLABLE_M027_LU: char = '𞠸';
    /// \u{1e839}: '𞠹'
    pub const SYLLABLE_M084_LEE: char = '𞠹';
    /// \u{1e83a}: '𞠺'
    pub const SYLLABLE_M073_LE: char = '𞠺';
    /// \u{1e83b}: '𞠻'
    pub const SYLLABLE_M054_LOO: char = '𞠻';
    /// \u{1e83c}: '𞠼'
    pub const SYLLABLE_M153_LO: char = '𞠼';
    /// \u{1e83d}: '𞠽'
    pub const SYLLABLE_M110_LONG_LE: char = '𞠽';
    /// \u{1e83e}: '𞠾'
    pub const SYLLABLE_M016_DI: char = '𞠾';
    /// \u{1e83f}: '𞠿'
    pub const SYLLABLE_M017_DA: char = '𞠿';
    /// \u{1e840}: '𞡀'
    pub const SYLLABLE_M018_DU: char = '𞡀';
    /// \u{1e841}: '𞡁'
    pub const SYLLABLE_M089_DEE: char = '𞡁';
    /// \u{1e842}: '𞡂'
    pub const SYLLABLE_M180_DOO: char = '𞡂';
    /// \u{1e843}: '𞡃'
    pub const SYLLABLE_M181_DO: char = '𞡃';
    /// \u{1e844}: '𞡄'
    pub const SYLLABLE_M022_TI: char = '𞡄';
    /// \u{1e845}: '𞡅'
    pub const SYLLABLE_M023_TA: char = '𞡅';
    /// \u{1e846}: '𞡆'
    pub const SYLLABLE_M024_TU: char = '𞡆';
    /// \u{1e847}: '𞡇'
    pub const SYLLABLE_M091_TEE: char = '𞡇';
    /// \u{1e848}: '𞡈'
    pub const SYLLABLE_M055_TE: char = '𞡈';
    /// \u{1e849}: '𞡉'
    pub const SYLLABLE_M104_TOO: char = '𞡉';
    /// \u{1e84a}: '𞡊'
    pub const SYLLABLE_M069_TO: char = '𞡊';
    /// \u{1e84b}: '𞡋'
    pub const SYLLABLE_M028_JI: char = '𞡋';
    /// \u{1e84c}: '𞡌'
    pub const SYLLABLE_M029_JA: char = '𞡌';
    /// \u{1e84d}: '𞡍'
    pub const SYLLABLE_M030_JU: char = '𞡍';
    /// \u{1e84e}: '𞡎'
    pub const SYLLABLE_M157_JEE: char = '𞡎';
    /// \u{1e84f}: '𞡏'
    pub const SYLLABLE_M113_JE: char = '𞡏';
    /// \u{1e850}: '𞡐'
    pub const SYLLABLE_M160_JOO: char = '𞡐';
    /// \u{1e851}: '𞡑'
    pub const SYLLABLE_M063_JO: char = '𞡑';
    /// \u{1e852}: '𞡒'
    pub const SYLLABLE_M175_LONG_JO: char = '𞡒';
    /// \u{1e853}: '𞡓'
    pub const SYLLABLE_M031_YI: char = '𞡓';
    /// \u{1e854}: '𞡔'
    pub const SYLLABLE_M032_YA: char = '𞡔';
    /// \u{1e855}: '𞡕'
    pub const SYLLABLE_M033_YU: char = '𞡕';
    /// \u{1e856}: '𞡖'
    pub const SYLLABLE_M109_YEE: char = '𞡖';
    /// \u{1e857}: '𞡗'
    pub const SYLLABLE_M080_YE: char = '𞡗';
    /// \u{1e858}: '𞡘'
    pub const SYLLABLE_M141_YOO: char = '𞡘';
    /// \u{1e859}: '𞡙'
    pub const SYLLABLE_M121_YO: char = '𞡙';
    /// \u{1e85a}: '𞡚'
    pub const SYLLABLE_M034_FI: char = '𞡚';
    /// \u{1e85b}: '𞡛'
    pub const SYLLABLE_M035_FA: char = '𞡛';
    /// \u{1e85c}: '𞡜'
    pub const SYLLABLE_M036_FU: char = '𞡜';
    /// \u{1e85d}: '𞡝'
    pub const SYLLABLE_M078_FEE: char = '𞡝';
    /// \u{1e85e}: '𞡞'
    pub const SYLLABLE_M075_FE: char = '𞡞';
    /// \u{1e85f}: '𞡟'
    pub const SYLLABLE_M133_FOO: char = '𞡟';
    /// \u{1e860}: '𞡠'
    pub const SYLLABLE_M088_FO: char = '𞡠';
    /// \u{1e861}: '𞡡'
    pub const SYLLABLE_M197_FUA: char = '𞡡';
    /// \u{1e862}: '𞡢'
    pub const SYLLABLE_M101_FAN: char = '𞡢';
    /// \u{1e863}: '𞡣'
    pub const SYLLABLE_M037_NIN: char = '𞡣';
    /// \u{1e864}: '𞡤'
    pub const SYLLABLE_M038_NAN: char = '𞡤';
    /// \u{1e865}: '𞡥'
    pub const SYLLABLE_M039_NUN: char = '𞡥';
    /// \u{1e866}: '𞡦'
    pub const SYLLABLE_M117_NEN: char = '𞡦';
    /// \u{1e867}: '𞡧'
    pub const SYLLABLE_M169_NON: char = '𞡧';
    /// \u{1e868}: '𞡨'
    pub const SYLLABLE_M176_HI: char = '𞡨';
    /// \u{1e869}: '𞡩'
    pub const SYLLABLE_M041_HA: char = '𞡩';
    /// \u{1e86a}: '𞡪'
    pub const SYLLABLE_M186_HU: char = '𞡪';
    /// \u{1e86b}: '𞡫'
    pub const SYLLABLE_M040_HEE: char = '𞡫';
    /// \u{1e86c}: '𞡬'
    pub const SYLLABLE_M096_HE: char = '𞡬';
    /// \u{1e86d}: '𞡭'
    pub const SYLLABLE_M042_HOO: char = '𞡭';
    /// \u{1e86e}: '𞡮'
    pub const SYLLABLE_M140_HO: char = '𞡮';
    /// \u{1e86f}: '𞡯'
    pub const SYLLABLE_M083_HEEI: char = '𞡯';
    /// \u{1e870}: '𞡰'
    pub const SYLLABLE_M128_HOOU: char = '𞡰';
    /// \u{1e871}: '𞡱'
    pub const SYLLABLE_M053_HIN: char = '𞡱';
    /// \u{1e872}: '𞡲'
    pub const SYLLABLE_M130_HAN: char = '𞡲';
    /// \u{1e873}: '𞡳'
    pub const SYLLABLE_M087_HUN: char = '𞡳';
    /// \u{1e874}: '𞡴'
    pub const SYLLABLE_M052_HEN: char = '𞡴';
    /// \u{1e875}: '𞡵'
    pub const SYLLABLE_M193_HON: char = '𞡵';
    /// \u{1e876}: '𞡶'
    pub const SYLLABLE_M046_HUAN: char = '𞡶';
    /// \u{1e877}: '𞡷'
    pub const SYLLABLE_M090_NGGI: char = '𞡷';
    /// \u{1e878}: '𞡸'
    pub const SYLLABLE_M043_NGGA: char = '𞡸';
    /// \u{1e879}: '𞡹'
    pub const SYLLABLE_M082_NGGU: char = '𞡹';
    /// \u{1e87a}: '𞡺'
    pub const SYLLABLE_M115_NGGEE: char = '𞡺';
    /// \u{1e87b}: '𞡻'
    pub const SYLLABLE_M146_NGGE: char = '𞡻';
    /// \u{1e87c}: '𞡼'
    pub const SYLLABLE_M156_NGGOO: char = '𞡼';
    /// \u{1e87d}: '𞡽'
    pub const SYLLABLE_M120_NGGO: char = '𞡽';
    /// \u{1e87e}: '𞡾'
    pub const SYLLABLE_M159_NGGAA: char = '𞡾';
    /// \u{1e87f}: '𞡿'
    pub const SYLLABLE_M127_NGGUA: char = '𞡿';
    /// \u{1e880}: '𞢀'
    pub const SYLLABLE_M086_LONG_NGGE: char = '𞢀';
    /// \u{1e881}: '𞢁'
    pub const SYLLABLE_M106_LONG_NGGOO: char = '𞢁';
    /// \u{1e882}: '𞢂'
    pub const SYLLABLE_M183_LONG_NGGO: char = '𞢂';
    /// \u{1e883}: '𞢃'
    pub const SYLLABLE_M155_GI: char = '𞢃';
    /// \u{1e884}: '𞢄'
    pub const SYLLABLE_M111_GA: char = '𞢄';
    /// \u{1e885}: '𞢅'
    pub const SYLLABLE_M168_GU: char = '𞢅';
    /// \u{1e886}: '𞢆'
    pub const SYLLABLE_M190_GEE: char = '𞢆';
    /// \u{1e887}: '𞢇'
    pub const SYLLABLE_M166_GUEI: char = '𞢇';
    /// \u{1e888}: '𞢈'
    pub const SYLLABLE_M167_GUAN: char = '𞢈';
    /// \u{1e889}: '𞢉'
    pub const SYLLABLE_M184_NGEN: char = '𞢉';
    /// \u{1e88a}: '𞢊'
    pub const SYLLABLE_M057_NGON: char = '𞢊';
    /// \u{1e88b}: '𞢋'
    pub const SYLLABLE_M177_NGUAN: char = '𞢋';
    /// \u{1e88c}: '𞢌'
    pub const SYLLABLE_M068_PI: char = '𞢌';
    /// \u{1e88d}: '𞢍'
    pub const SYLLABLE_M099_PA: char = '𞢍';
    /// \u{1e88e}: '𞢎'
    pub const SYLLABLE_M050_PU: char = '𞢎';
    /// \u{1e88f}: '𞢏'
    pub const SYLLABLE_M081_PEE: char = '𞢏';
    /// \u{1e890}: '𞢐'
    pub const SYLLABLE_M051_PE: char = '𞢐';
    /// \u{1e891}: '𞢑'
    pub const SYLLABLE_M102_POO: char = '𞢑';
    /// \u{1e892}: '𞢒'
    pub const SYLLABLE_M066_PO: char = '𞢒';
    /// \u{1e893}: '𞢓'
    pub const SYLLABLE_M145_MBI: char = '𞢓';
    /// \u{1e894}: '𞢔'
    pub const SYLLABLE_M062_MBA: char = '𞢔';
    /// \u{1e895}: '𞢕'
    pub const SYLLABLE_M122_MBU: char = '𞢕';
    /// \u{1e896}: '𞢖'
    pub const SYLLABLE_M047_MBEE: char = '𞢖';
    /// \u{1e897}: '𞢗'
    pub const SYLLABLE_M188_MBEE: char = '𞢗';
    /// \u{1e898}: '𞢘'
    pub const SYLLABLE_M072_MBE: char = '𞢘';
    /// \u{1e899}: '𞢙'
    pub const SYLLABLE_M172_MBOO: char = '𞢙';
    /// \u{1e89a}: '𞢚'
    pub const SYLLABLE_M174_MBO: char = '𞢚';
    /// \u{1e89b}: '𞢛'
    pub const SYLLABLE_M187_MBUU: char = '𞢛';
    /// \u{1e89c}: '𞢜'
    pub const SYLLABLE_M161_LONG_MBE: char = '𞢜';
    /// \u{1e89d}: '𞢝'
    pub const SYLLABLE_M105_LONG_MBOO: char = '𞢝';
    /// \u{1e89e}: '𞢞'
    pub const SYLLABLE_M142_LONG_MBO: char = '𞢞';
    /// \u{1e89f}: '𞢟'
    pub const SYLLABLE_M132_KPI: char = '𞢟';
    /// \u{1e8a0}: '𞢠'
    pub const SYLLABLE_M092_KPA: char = '𞢠';
    /// \u{1e8a1}: '𞢡'
    pub const SYLLABLE_M074_KPU: char = '𞢡';
    /// \u{1e8a2}: '𞢢'
    pub const SYLLABLE_M044_KPEE: char = '𞢢';
    /// \u{1e8a3}: '𞢣'
    pub const SYLLABLE_M108_KPE: char = '𞢣';
    /// \u{1e8a4}: '𞢤'
    pub const SYLLABLE_M112_KPOO: char = '𞢤';
    /// \u{1e8a5}: '𞢥'
    pub const SYLLABLE_M158_KPO: char = '𞢥';
    /// \u{1e8a6}: '𞢦'
    pub const SYLLABLE_M124_GBI: char = '𞢦';
    /// \u{1e8a7}: '𞢧'
    pub const SYLLABLE_M056_GBA: char = '𞢧';
    /// \u{1e8a8}: '𞢨'
    pub const SYLLABLE_M148_GBU: char = '𞢨';
    /// \u{1e8a9}: '𞢩'
    pub const SYLLABLE_M093_GBEE: char = '𞢩';
    /// \u{1e8aa}: '𞢪'
    pub const SYLLABLE_M107_GBE: char = '𞢪';
    /// \u{1e8ab}: '𞢫'
    pub const SYLLABLE_M071_GBOO: char = '𞢫';
    /// \u{1e8ac}: '𞢬'
    pub const SYLLABLE_M070_GBO: char = '𞢬';
    /// \u{1e8ad}: '𞢭'
    pub const SYLLABLE_M171_RA: char = '𞢭';
    /// \u{1e8ae}: '𞢮'
    pub const SYLLABLE_M123_NDI: char = '𞢮';
    /// \u{1e8af}: '𞢯'
    pub const SYLLABLE_M129_NDA: char = '𞢯';
    /// \u{1e8b0}: '𞢰'
    pub const SYLLABLE_M125_NDU: char = '𞢰';
    /// \u{1e8b1}: '𞢱'
    pub const SYLLABLE_M191_NDEE: char = '𞢱';
    /// \u{1e8b2}: '𞢲'
    pub const SYLLABLE_M119_NDE: char = '𞢲';
    /// \u{1e8b3}: '𞢳'
    pub const SYLLABLE_M067_NDOO: char = '𞢳';
    /// \u{1e8b4}: '𞢴'
    pub const SYLLABLE_M064_NDO: char = '𞢴';
    /// \u{1e8b5}: '𞢵'
    pub const SYLLABLE_M152_NJA: char = '𞢵';
    /// \u{1e8b6}: '𞢶'
    pub const SYLLABLE_M192_NJU: char = '𞢶';
    /// \u{1e8b7}: '𞢷'
    pub const SYLLABLE_M149_NJEE: char = '𞢷';
    /// \u{1e8b8}: '𞢸'
    pub const SYLLABLE_M134_NJOO: char = '𞢸';
    /// \u{1e8b9}: '𞢹'
    pub const SYLLABLE_M182_VI: char = '𞢹';
    /// \u{1e8ba}: '𞢺'
    pub const SYLLABLE_M185_VA: char = '𞢺';
    /// \u{1e8bb}: '𞢻'
    pub const SYLLABLE_M151_VU: char = '𞢻';
    /// \u{1e8bc}: '𞢼'
    pub const SYLLABLE_M173_VEE: char = '𞢼';
    /// \u{1e8bd}: '𞢽'
    pub const SYLLABLE_M085_VE: char = '𞢽';
    /// \u{1e8be}: '𞢾'
    pub const SYLLABLE_M144_VOO: char = '𞢾';
    /// \u{1e8bf}: '𞢿'
    pub const SYLLABLE_M077_VO: char = '𞢿';
    /// \u{1e8c0}: '𞣀'
    pub const SYLLABLE_M164_NYIN: char = '𞣀';
    /// \u{1e8c1}: '𞣁'
    pub const SYLLABLE_M058_NYAN: char = '𞣁';
    /// \u{1e8c2}: '𞣂'
    pub const SYLLABLE_M170_NYUN: char = '𞣂';
    /// \u{1e8c3}: '𞣃'
    pub const SYLLABLE_M098_NYEN: char = '𞣃';
    /// \u{1e8c4}: '𞣄'
    pub const SYLLABLE_M060_NYON: char = '𞣄';
    /// \u{1e8c7}: '𞣇'
    ...
    /// \u{1e8d0}: '𞣐'
    pub const COMBINING_NUMBER_TEENS: char = '𞣐';
    /// \u{1e8d1}: '𞣑'
    pub const COMBINING_NUMBER_TENS: char = '𞣑';
    /// \u{1e8d2}: '𞣒'
    pub const COMBINING_NUMBER_HUNDREDS: char = '𞣒';
    /// \u{1e8d3}: '𞣓'
    pub const COMBINING_NUMBER_THOUSANDS: char = '𞣓';
    /// \u{1e8d4}: '𞣔'
    pub const COMBINING_NUMBER_TEN_THOUSANDS: char = '𞣔';
    /// \u{1e8d5}: '𞣕'
    pub const COMBINING_NUMBER_HUNDRED_THOUSANDS: char = '𞣕';
    /// \u{1e8d6}: '𞣖'
    pub const COMBINING_NUMBER_MILLIONS: char = '𞣖';
}
